...
load(paste0(currentdirectory,'/natmed_parameters.RData'))
...
if (make_efficacies){ 
  ...
  saveRDS(log10_neut_efficacy_lookup,paste0(currentdirectory,'/WP4efficacylookup.RDS')) 
}
if (save_csv){ write.csv(log10_neut_efficacy_lookup, paste0(currentdirectory,'/WP4efficacylookup.csv'))}
if (read_efficacies){ log10_neut_efficacy_lookup=readRDS(paste0(currentdirectory,'/WP4efficacylookup.RDS'))}
